...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _AnimationQueue_26():import18.AnimationQueue {
    if ((this.__AnimationQueue_26 == null)) { (this.__AnimationQueue_26 = new import18.AnimationQueue(this.parent.get(import31.NgZone))); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import34.LOCALE_ID)) { return this._LOCALE_ID_7; }
